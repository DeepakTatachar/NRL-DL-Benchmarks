...
#training parameters
parser.add_argument('--epochs',                 default=5,                  type=int,       help='Set number of epochs')
...
framework.train(epoch_hook=epoch_hook, parallel=args.parallel, parallel_device_ids=[0,1,2,3])
